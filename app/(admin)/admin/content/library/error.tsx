...
export default function AdminContentLibraryError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
      ...
      <Card className="my-0 max-w-2xl">
        <CardContent className="flex items-start gap-3 p-5">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-lg font-bold">Content library failed to load</h1>
